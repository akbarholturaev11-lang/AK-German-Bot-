...
async def cmd_start(
    ...
    await message.answer(
        t("welcome", user.language, name=first_name),
        reply_markup=main_menu_keyboard(user.language),
    )
    ...
    challenges = {
        "beginner": {
            "tj": (
                ...
                "✨ <b>Hallo</b> · <b>Danke</b> · <b>Tschüss</b>\n\n"
                "Аз ин калимаҳо як ҷумла созед — хато ҳам бошад, бот тасҳеҳ мекунад 😄",
                "The user just started learning German (beginner level). "
                "You gave them a challenge: make a sentence using Hallo, Danke, Tschüss. "
        ...
        "hsk1": {
            "tj": (
                "🎯 <b>A1 — Мушкилӣ надорад!</b>\n\n"
                "Ин 3 рақами олмониро хонед:\n\n"
                "🔢 <b>drei</b> · <b>zehn</b> · <b>hundert</b>\n\n"
                "Ҷумлае бо рақамҳо бисозед — масалан синнатон ё шумораи чизе 🕵️",
                "The user is German A1 level. You gave them a challenge: "
                "make a sentence using German numbers drei(3), zehn(10), hundert(100). "
                "Their next message is their attempt. Correct and encourage."
            ),
            "uz": (
                "🎯 <b>A1 — Qiyin emas!</b>\n\n"
                "Bu 3 ta nemischa raqamni o'qing:\n\n"
                "🔢 <b>drei</b> · <b>zehn</b> · <b>hundert</b>\n\n"
            ...
            "ru": (
                "🎯 <b>A1 — Это несложно!</b>\n\n"
                "Прочитайте эти 3 немецких числа:\n\n"
                "🔢 <b>drei</b> · <b>zehn</b> · <b>hundert</b>\n\n"
        ...
        "hsk2": {
            "tj": (
                "🕵️ <b>A2 — Сир нигоҳ доред!</b>\n\n"
                "Дар ин ҷумла як иборае пинҳон аст:\n\n"
                "🇩🇪 <b>freue · mich · dich</b>\n\n"
                "Ин калимаҳоро дар як ҷумла ҷамъ кунед — ибораи машҳур ҳосил мешавад 😏",
                "The user is German A2 level. You gave them a challenge: "
                "combine freue, mich, dich into a sentence. "
                "The hidden phrase is Ich freue mich, dich kennenzulernen. Their next message is their attempt. "
                "Reveal the famous phrase if they get close, explain it warmly."
            ),
            "uz": (
                "🕵️ <b>A2 — Sir saqlang!</b>\n\n"
        ...
        "hsk3": {
            "tj": (
                "🔥 <b>B1 — Имтиҳони зудӣ!</b>\n\n"
                "Ин ҷумларо тарҷума кунед:\n\n"
                "🇩🇪 <b>Wie fühlst du dich heute?</b>\n\n"
                "Ҷавобро ба олмонӣ бинависед — ҳеҷ луғат истифода набаред 😤",
                "The user is German B1 level. You gave them a challenge: "
                "translate Wie fühlst du dich heute? and answer in German without a dictionary. "
                "Their next message is their attempt. Evaluate their German, correct errors, praise effort."
            ),
            "uz": (
                "🔥 <b>B1 — Tezkor imtihon!</b>\n\n"
                "Bu jumlani tarjima qiling:\n\n"
                "🇩🇪 <b>Wie fühlst du dich heute?</b>\n\n"
                "Javobni nemischa yozing — lug'atsiz 😤",
                "The user is German B1 level. You gave them a challenge: "
                "translate Wie fühlst du dich heute? and answer in German without a dictionary. "
                "Their next message is their attempt. Evaluate their German, correct errors, praise effort."
            ),
            "ru": (
                ...
                "🇩🇪 <b>Wie fühlst du dich heute?</b>\n\n"
                "Ответьте по-немецки — без словаря 😤",
                "The user is German B1 level. You gave them a challenge: "
                "translate Wie fühlst du dich heute? and answer in German without a dictionary. "
                "Their next message is their attempt. Evaluate their German, correct errors, praise effort."
            ),
        ...
        "hsk4": {
            "tj": (
                ...
                "The user is German B2 level. You gave them a challenge: "
                "use the grammar pattern obwohl ... trotzdem ... in a complex sentence about their life. "
